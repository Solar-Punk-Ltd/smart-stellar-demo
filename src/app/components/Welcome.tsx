...
export default function Welcome() {
  ...
  async function callGetMessages() {
    ...
    _msgs = _msgs.sort((a, b) => a.timestamp.getTime() - b.timestamp.getTime());
  ...
  async function callGetEvents(limit: number | string, found: boolean = false) {
              ...
              <li className="mb-2" key={i}>
                <span className="text-mono text-sm bg-black rounded-t-lg text-white px-3 py-1">
                  <a
                    ...
                    target="_blank"
                    href={
                      "https://stellar.expert/explorer/public/tx/" + msg.txHash
                    }
                  >
                    {truncate(msg.addr, 4)}
                  </a>
